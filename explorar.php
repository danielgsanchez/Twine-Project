                ...
                <div class="col-md-6">
                    <div class="card-deck">
                        <?php if ($randomProfile) : ?>
                            <div class="card">
                                <img style="display: block; margin: 0 auto; object-fit:cover" src="<?php echo $randomProfile['link'] ? $randomProfile['link'] : 'chat_imgs/user_pics/default.png'; ?>" class="card-img-top" alt="Foto de perfil">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <strong>
